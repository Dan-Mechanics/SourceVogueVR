...
namespace VogueVR.Gameplay
{
    ...
    public class SongRecorder : MonoBehaviour
    {
        ...
        [SerializeField] private BeatHittingController leftHand = default;
        [SerializeField] private BeatHittingController rightHand = default;
        ...
        public void CaptureBeat(int bodyPart) 
        {
            ...
            this.recording.Enqueue(new SongBeat(Time.time - this.openRecordingTime,
                 part == BodyPart.LeftHand ? this.leftHand.transform.position : this.rightHand.transform.position, part));
